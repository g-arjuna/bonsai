...
fn classified_event_type(update: &TelemetryUpdate) -> &'static str {
    match update.classify() {
        ...
        TelemetryEvent::InterfaceDescription { .. } => "interface_description",
        TelemetryEvent::ServiceEndpoint { .. } => "service_endpoint",
        TelemetryEvent::QoSPolicyChange { .. } => "qos_policy_change",
        ...
        TelemetryEvent::BmpInitiation => "bmp_initiation",
        TelemetryEvent::BmpStatisticsReport => "bmp_statistics_report",
        TelemetryEvent::BgpLsState => "bgp_ls_state",
        TelemetryEvent::ConfigChange { .. } => "config_change",
        TelemetryEvent::OtlpSpan { .. } => "otlp_span",
        TelemetryEvent::OtlpMetrics { .. } => "otlp_metrics",
        TelemetryEvent::NetflowRecord { .. } => "netflow_record",
        TelemetryEvent::SflowRecord { .. } => "sflow_record",
        TelemetryEvent::SflowCounters { .. } => "sflow_counters",
        TelemetryEvent::EnvSensor { .. } => "env_sensor",
        TelemetryEvent::OpticsDiagnostics { .. } => "optics_diagnostics",
